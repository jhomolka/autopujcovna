...
class db
{
	...
	*/
    ...
    public function updatePujceno($pujceno, $id_auta)
	{
	    // PDO - MySQL
	 	...
	 	$mysql_pdo_error = false;
            ...
            $query = "update auta set pujceno='".$pujceno."' where id_auta=$id_auta";
            //$query = "update ".$table_name." set pujceno=ANO ".$where_pom."";
            //echo $query;
